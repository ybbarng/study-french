...
| grammaire | W | **⭐최우선: 관사 les(전부·일반론) ↔ des/d'autres(몇몇·불특정)**. 주어 자리 일반론=**les** / 목적어 "몇몇 ~을"=**des**. autre 앞에서는 des→**d'autres** | **Les** voyages coûtent cher(일반론) ↔ découvrir **d'autres** cultures · vivre **des** expériences | 8/31 평가 다수 ❌ → 9/10 워밍업 Les jeux vidéo ✅**BUT** 자유산출 **0/2 자가검출**(les autres cultures·les expériences ❌) — **지금 최대 취약** | 2026-08-31 | 2026-09-11 | 1 |
| grammaire | W | **형용사 성수일치 = 지식 아닌 일관성**(자유산출 -s 누락). 스캔: **복수 명사→형용사마다 -s** (후치·술어 둘 다) | hautes montagnes·grandes fêtes·toutes régions·blanche·recouverte — bon marché·bleu clair는 **불변** | 8/31 혼재 ❌ → 9/3·9/4 clean ✅ → **9/10 재발 3회**: sont **cher**·trop **cher**·expériences **inhabituels**(여성 미인지). 술어 위치 -s가 약점 | 2026-08-31 | 2026-09-11 | 2 |
...
| chunk | W | **동사 반복 회피 3종**: 대동사 **le faire**(=do so, `le` 필수) · 강세대명사 **eux/lui** 대조 · **contrairement à** | Les Coréens ne soulèvent pas le bol, les Japonais, **eux, le font** / **Contrairement aux** Français… | 9/10 신규 — 몰라서 동사구를 통째로 반복했음. 재생산 2문장 ✅ (한 번 더 확인 필요) | 2026-09-10 | 2026-09-11 | 1 |
...
| 카테고리 | reg | 표현/패턴 | 의미·용법 | 흔한 오류 | 등록일 | 다음 복습일 | 사용 |
|---|---|---|---|---|---|---|---|
| grammaire | S | **en + 수량**: 수를 말하면 les가 아니라 **en**(=de+명사) · **en 뒤 과거분사 불변** | j'**en** ai acheté **deux** / il **en** a beaucoup ↔ je **les** ai achetés(전부) | 9/10 신규 — les…deux ❌. 설명 후 2회 정확 ✅ | 2026-09-10 | 2026-09-11 | 2 |
