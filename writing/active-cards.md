...
| grammaire | S | **⭐최우선: 동사 인칭 = 명사 주어를 먼저 대명사로 환산**(les jeux vidéo→**ils**→contribu**ent**). 환산 없이 쓰면 nous형/il형이 튀어나옴 | les jeux vidéo **contribuent** · les fans **soutiennent** · les enfants **jouent, chantent** | 9/8 3회 재발 → **9/9 환산 습관 도입 후 6개 전부 정확** ✅(étudient·encourage·soutiennent·jouent·chantent·s'entraînent). 잔여: *ils **joue*** ❌(한 문장 **두 번째** 동사) → **9/10 워밍업 전부 ✅**. 자유산출 오류는 성격 변화 = **편집 슬립**(les voyages **est**: 주어를 le prix→les voyages로 갈면서 동사 미확인). 처방 = **"주어를 고치면 그 절 동사를 다시 읽는다"**. 9/11 자유산출 2회 재발(je ne **voulait**·ils se **déteste**) — 부하 걸리면 먼저 꺼지는 항목 | 2026-08-06 | 2026-09-12 | 5 |
| grammaire | S | **⭐복합주어 X et moi = nous** (형제·연인·친구 + moi → 동사·조동사·재귀 전부 nous형) | Mon frère et moi, **nous nous sommes levés** ✅ / Ma copine et moi **sommes** allés | Mes amis et moi *sont* ❌ (9/9) → **9/10 워밍업 한 번에 sommes ✅** | 2026-09-04 | 2026-09-13 | 3 |
...
| grammaire | W | **⭐최우선: 관사 les(전부·일반론) ↔ des/d'autres(몇몇·불특정)**. 주어 자리 일반론=**les** / 목적어 "몇몇 ~을"=**des**. autre 앞에서는 des→**d'autres** | **Les** voyages coûtent cher(일반론) ↔ découvrir **d'autres** cultures · vivre **des** expériences | 8/31 다수 ❌ → 9/10 자유산출 0/2 → **9/11 워밍업 Les voyages + d'autres pays 한 번에 ✅ 회복**. 신규 경계: **en + 무관사**(en montagne·en ville)는 **형용사 붙으면 불가** → en montagne **proche** ❌ → à la montagne la plus proche | 2026-08-31 | 2026-09-12 | 2 |
| grammaire | W | **형용사 성수일치 = 지식 아닌 일관성**(자유산출 -s 누락). 스캔: **복수 명사→형용사마다 -s** (후치·술어 둘 다) | hautes montagnes·grandes fêtes·toutes régions·blanche·recouverte — bon marché·bleu clair는 **불변** | 8/31 혼재 ❌ → 9/3·9/4 clean ✅ → 9/10 재발 3회 → **9/11 경계 습득**: *coûter cher·payer cher·sentir bon*의 cher/bon은 **부사라 불변**(coûtent **chers** ❌) ↔ *être cher*는 형용사라 일치. 그리고 **avoir + COD 선행** 일치(nous a essouffl**és**)는 규칙으로 추론 성공 | 2026-08-31 | 2026-09-12 | 3 |
...
| chunk | W | **동사 반복 회피 3종**: 대동사 **le faire**(=do so, `le` 필수) · 강세대명사 **eux/lui** 대조 · **contrairement à** | Les Coréens ne soulèvent pas le bol, les Japonais, **eux, le font** / **Contrairement aux** Français… | 9/10 신규 → **9/11 le faire·moi si 둘 다 ✅**. ⚠️ **정정**: "프랑스어엔 대조 긍정어가 없다"는 내 설명이 과했음 — **« Moi, si »/« Lui, si »는 실제로 쓴다**(구어). 문어 논증에선 le faire·contrairement à가 나음 | 2026-09-10 | 2026-09-13 | 2 |
...
| 카테고리 | reg | 표현/패턴 | 의미·용법 | 흔한 오류 | 등록일 | 다음 복습일 | 사용 |
|---|---|---|---|---|---|---|---|
| grammaire | S | **en + 수량**: 수를 말하면 les가 아니라 **en**(=de+명사) · **en 뒤 과거분사 불변** | j'**en** ai acheté **deux** / il **en** a beaucoup ↔ je **les** ai achetés(전부) | 9/10 신규(les…deux ❌) → **9/11 워밍업 ✅ + 자유산출에서 자발적으로 2회**(ça n'**en** vaudrait pas la peine · je **n'en** ai pas eu hâte) | 2026-09-10 | 2026-09-14 | 4 |
| cliché | S | **douter que + 접속법**(의심하다=아닐 것 같다) ↔ **se douter que + 직설법**(짐작하다=그럴 것 같다) — 재귀 하나가 뜻을 뒤집음. 주어가 같으면 **douter de + 부정사** | Je doute qu'il **ait** dit la vérité / Je **me doutais** qu'il **avait** menti | Je **me** doute qu'il ait ❌ (9/11, se+접속법 혼합) · 같은 주어인데 que절 ❌ | 2026-09-11 | 2026-09-12 | 1 |
| grammaire | S | **간접의문문에 que를 붙이지 않는다** — 의문사를 그대로 가져오되 qu'est-ce que→**ce que** / qu'est-ce qui→**ce qui** / 예·아니오 질문→**si** | Je me suis rendu compte **pourquoi** on fait ça / Je sais **où** il est / Je me demande **si** tu viens | rendu compte **que pourquoi** ❌ (9/11). ⚠️ 혼동 주의: *Il a dit **que quand** il serait prêt…*의 quand은 **의문사가 아니라 접속사** | 2026-09-11 | 2026-09-12 | 0 |
| cliché | S | **meilleur**(형용사, bon의 비교급) ≠ **mieux**(부사, bien의 비교급) · "~하는 편이 낫다"=**il vaut mieux** · "~하길 잘했다"=**avoir bien fait de** | Ce gâteau est **meilleur** ↔ Il vaut **mieux** venir / j'avais **bien fait** de venir | il était **meilleur** de venir ❌ (9/11) | 2026-09-11 | 2026-09-12 | 0 |
| grammaire | S | **en valoir la peine은 동사구** — valoir를 활용한다(**vaut**). `en`은 앞에 말한 걸 받을 때만, 내용을 직접 말하면 **de + 원형** (둘을 같이 쓰지 않음) | Ça **en** vaut la peine. ↔ Ça vaut la peine **d'**essayer. | **C'est en valoir** la peine ❌ (9/11) | 2026-09-11 | 2026-09-12 | 1 |
| grammaire | S | **douter que + 접속법** · **en valoir la peine**(그럴 가치가 있다, valoir는 동사라 목적어 필요) | je doute qu'ils **vaillent** leur prix / ça **en vaut la peine** | on a un doute qu'ils **valent** ❌ · ils **sont valent** ❌ (valoir를 형용사로 착각, 9/10) | 2026-09-10 | 2026-09-11 | 0 |
| grammaire | W | **민족·국민 명사는 대문자** / 형용사·언어는 소문자 | les **Coréens**, les **Japonais** ↔ la cuisine **coréenne**, je parle **coréen** | les coréens·les japonais ❌ (9/10, 규칙 자체를 몰랐음) | 2026-09-10 | 2026-09-11 | 0 |
| cliché | W | **expérimenter는 추상적 체험에만** (la solitude·la peur·la vie à l'étranger ✅) — 시각 대상엔 **voir/admirer/contempler**. + 같은 동사 4회 반복은 어휘 감점 → **vivre·découvrir·voir 회전** | expérimenter la difficulté ✅ ↔ **voir** l'aurore boréale | expérimenter l'aurore boréale △ ×2 (9/10). ⚠️ 사전 뜻 "경험하다"는 **정상** — 내 초기 faux-ami 판정은 오류(정정) | 2026-09-10 | 2026-09-12 | 0 |
...
| grammaire | W | 소유형용사는 **소유자(주어) 인칭 + 소유물의 수** 둘 다 일치: il→son/ses · ils→leur/**leurs** · nous→notre/**nos**. 그리고 **소유형용사 뒤에 관사 X** | **nos** parents · **leur** équipe · **leurs** progrès | Ils…son rôle ❌ / notre parents·leur l'équipe ❌ (9/9) → **9/10 nos/leurs 재생산 ✅, 관사 중복은 미검출**(카테고리 힌트 후 ✅) · 재생산서 **ses**chaussures ❌→leurs(자가 도출) | 2026-07-24 | 2026-09-11 | 1 |
| grammaire | S | **재귀대명사도 주어 인칭에 일치**: je→me · tu→te · nous(=X et moi)→**nous** · ils→se. 조동사는 **être**, 과거분사는 주어 일치 | **nous nous sommes** levés · ils **se sont** levés · je **me suis** dit | 9/9 재생산 전부 정확 ✅ → **9/10 se couchent ✅** (2회 연속) | 2026-09-09 | 2026-09-13 | 2 |
...
| grammaire | W | **⭐고질: parler는 que절 못 받음** — parler **de**(~에 대해)/**à**(~에게) ↔ dire **que**(~라고) · "~라고들 한다"=**On dit que** | On **dit** que… / parler **de** ses problèmes | 8/23·8/27·9/8 재발 → **9/9 2회 + 9/10 자유산출·워밍업 정확** ✅ = **3세션 연속, 정착 판정 → T2 강등**. 잔여: parler **au** cinéma ❌(전치사 de 쪽은 아직) | 2026-08-11 | 2026-09-17 | 6 |
