...
- 현재 단계: 중급 (B1-B2)
- 다음 주제: **S4 부정 표현 + S7 수량 표현**. **S5 간접 의문문 ✅** (6/5, 82%). 워밍업 9/10 (-ture la peinture ❌, 접속법 트리거 자동화 ❌). 진척 63/68 = 92.6%. 6/9 묶음 J 소시험 빡빡 — 남은 S4/S6/S7/S8 + 15-1/15-2/15-3 = 7항목.
...
| S4 | 부정 표현 다양화 (ne...que/jamais/rien 등) | ⬜ | 🔴 | 40~60분 | 6/5 (S7과 함께) |
...
| S5 간접 의문문 | 2026-06-05 | 1일 후 | 2026-06-06 | 신규 학습 11문제 82% (9⭕+2부분❌). 단위 A/B/C/D 모두 다룸. 통합 응용 Q11 ⭕⭐⭐ |
...
- **-ture 어미 = 여성 (2일 연속 재발)** — 6/4 *"le culture"* ❌ → 6/5 Q8 *"le peinture"* ❌. -ture/-tion/-sion/-ence/-té 여성 4 어미 묶음. 다음 워밍업 강화 필요.
- **"il est + 형용사 + que" 접속법 트리거 자동화** — DELF Q32 ⭕했었으나 6/5 워밍업 Q10 *"il est important que tu es"* ❌. 트리거 카테고리 식별 자동화 미달. 일반 동사 (savoir/dire 등) + il est + 형용사 + que 구별 필요.
...
| rêver de (+ V원형/명사) | 2026-06-03 | 2026-06-05 | DELF Q24 ❌ → 6/4 Q9 ⭕ (직전 노출) → 6/5 Q3 *"rêve de devenir"* ⭕ (3일 연속). 자동화 진행 |
