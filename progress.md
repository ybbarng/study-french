...
- 현재 단계: 중급 (B1-B2)
- 다음 주제: **6/1 14-3 담화 연결 (논리 관계 5 카테고리)** + S4 부정 표현. **14-1 ✅, 14-2 ✅** 완료 (5/31). 묶음 I 이월 오답 3개 정착 ⭐. 진척 61/68 = 90%. **YouTube 인사이트 자료 추가** (6/1, `docs/youtube-insights/`) — 6/14~24 종합 복습에서 활용.
