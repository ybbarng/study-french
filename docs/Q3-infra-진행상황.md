...
| 7 | 회사 공유 자료 | ← 베이스라인 | ✅ **완료** (buzz-challenge/Q3/ 월별 추적) |
...
- ✅ **7 회사 공유 자료 완료** (6/22) — `buzz-challenge/Q3/` (README + 월별 7·8·9). 도전과제=월 1,500단어. **🎉 Q3 인프라 필수 7개 전부 완료.**
- 다음(선택): 추가 항목(blog·사전 chunk풀) 또는 7월부터 /write 본격 시작
