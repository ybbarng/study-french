...
- study-french에선 시험 범위 복습 + drill만.

### 6/25 직후 ~ 6/30 (Q3 인프라 구축 주간)
- 주로 study-french 쪽 (Q3 쓰기 인프라 7개 항목).
- **ftf 쪽 마무리 정리**:
  - study-french의 `shadowing/` 디렉토리 삭제 (이전 완료라 중복)
...
| 시점 | 결정 사항 | 비고 |
|---|---|---|
| 6/26~30 | study-french/shadowing 디렉토리 제거 + GitHub Pages 정리 | 안 정리하면 중복 |
